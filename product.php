...
$price = '';
$description = '';
$sql = "SELECT name, price, description FROM tbl_products WHERE id=:id";
...
$sql = 'SELECT name FROM tbl_product_images WHERE product_id=:id ORDER BY priority';
$stm = $conn->prepare($sql);
$stm->execute([":id"=>$id]);
$images = $stm->fetchAll();
?>
